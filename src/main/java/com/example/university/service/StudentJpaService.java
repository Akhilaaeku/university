...
import com.example.university.respository.CourseJpaRepository;
...
public class StudentJpaService implements StudentRepository {
    ...
    public Student addStudent(Student student) {
        ...
        for(Course course : student.getCourses()) {
            courseIds.add(course.getCoureId());
        }
    ...
    public Student updateStudent(int studentId, Student student) {
        try {
            ...
            if (student.getCourses() != null) {
                ...
                courseJpaRepository.saveAll(existingStudent);
                List<Integer> courseIds = new ArrayList<>();
                for(Course course : student.getCourses()) {
    ...
    public void deleteStudent(int studentId) {
        try {
            ...
            courseJpaRepository.saveAll(courses);
            studentJpaRepository.deleteById(courses);
        } catch (Exception e) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
